...
import os
from utils import get_mean_value, get_R_value, get_S_value, z_score_normalisation, optimale_scale_identification, hessian, get_Ht
...
def main():
    ...
    nib.save(glom_nifti, os.path.join("../output/" + sample + "_glomerular_mask.nii.gz"))
